...
export function TimelinePanelVariant2({
  ...
  return (
    <div className="rounded-[22px] bg-[radial-gradient(circle_at_15%_10%,rgba(38,92,255,0.34),transparent_30%),radial-gradient(circle_at_82%_20%,rgba(230,129,57,0.2),transparent_26%),linear-gradient(135deg,#121826,#070910)] p-px">
      <section className="rounded-[21px] border border-white/14 bg-white/[0.075] px-3 py-2.5 shadow-panel backdrop-blur-xl">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex min-w-0 items-baseline gap-2">
            ...
            <span className="hidden text-xs text-white/52 sm:inline">{rangeLabel}</span>
          </div>
          <div className="flex items-center gap-1.5">
            ...
            <label className="flex h-9 min-w-0 flex-1 items-center gap-2 rounded-full border border-white/15 bg-black/20 px-3 text-sm text-white sm:w-[156px]">
              <Calendar size={15} />
